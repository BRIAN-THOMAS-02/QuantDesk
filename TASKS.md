...
> `✅ DONE` · `🔄 IN-PROGRESS` · `⚠️ BLOCKED` · `⏳ PENDING`
>
...
| NSE live paths (option chain / FII-DII / whales) | ⚠️ BLOCKED on weekend — degrades gracefully; re-verify on trading day |
...
| **NSE public API** | option chains, FII/DII, bulk/block deals, delivery % | ⚠️ 403/blocked on weekends + non-browser; re-verify on trading day |
...
### ⚠️ BLOCKED (re-verify on a trading day / after Kite keys)
...
### ⚠️ Incident — index.html clobbered (recovered from git)
